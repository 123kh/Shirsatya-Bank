						...
						<div class="card">
							<div class="card-body">
								<div class="card-title d-flex align-items-center">
									...
									<h5 class="mb-0 text-primary">Total EMI Pendings</h5>
								</div>
								<hr>
								<form class="row g-2">
									<!-- <div class="col-md-3">
									...
									<div class="col-md-3">
										<label for="inputFirstName" class="form-label">Total EMI*</label>
										<input type="text" class="form-control" id="inputFirstName" placeholder="Total EMI">
									</div>
								 ...
								 <div class="col-md-3">
									...
									<div class="col-md-3">
										<label for="inputFirstName" class="form-label">EMI Amount*</label>
										<input type="text" class="form-control" id="inputFirstName" placeholder="EMI Amount">
									</div>
