					...
					<div class="col-md-12 mx-auto" >
						<div class="card">
							<div class="card-body">
								...
								<hr>
								<form class="row g-2" method="post" action="{{route('add_loan_scheme')}}">
									@csrf
									<!-- <div class="col-md-3">
									...
									<div class="col-md-2">
										...
										<input type="text" name="loan_scheme_name" class="form-control" id="inputFirstName" placeholder="Loan Scheme Name" Required>
									</div>
									
									
									<div class="col-md-2">
										<label class="form-label">Type of Intrest*</label>
										<select class="form-select " name="type_of_value_in_intrest" aria-label="Default select example" Required >
									...
									<div class="col-md-2">
										...
										<input type="text" name="value_of_intrest"  class="form-control" id="inputFirstName" placeholder="Value of Intrest" Required>
									</div>

									
									<div class="col-md-2">
										<label for="inputFirstName" class="form-label">Application Fees*</label>
										<input type="text" name="application_fees" class="form-control" id="inputFirstName" placeholder="Application Fees" Required>
									</div>

									<div class="col-md-2">
										<label for="inputFirstName" class="form-label">Processing Fees*</label>
										<input type="text" name="processing_fees"  class="form-control" id="inputFirstName" placeholder="Processing Fees" Required>
									</div>
									<div class="col-md-2">
										<label for="inputFirstName" class="form-label">Valuation Fees*</label>
										<input type="text" name='valuation_fees' class="form-control" id="inputFirstName" placeholder="Valuation Fees" Required>
									</div>
