						...
						<div class="card-body">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link active" data-bs-toggle="tab" href="#primaryhome" role="tab" aria-selected="true">
										<div class="d-flex align-items-center">
											...
											<div class="tab-title">All EMI</div>
										</div>
									</a>
								</li>
								<li class="nav-item" role="presentation">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link" data-bs-toggle="tab" href="#primarypro" role="tab" aria-selected="false">
										<div class="d-flex align-items-center">
											...
											<div class="tab-title">Pending EMI </div>
										</div>
									</a>
								</li>
							...
							<div class="tab-content py-3">
								<div class="tab-pane fade show active" id="primaryhome" role="tabpanel">
													...
													<h5 class="mb-0 text-primary">All EMI</h5>
												<hr>
												<form class="row g-2">
													{{-- @csrf --}}
													{{-- <input type="text" id="loan_id2" name="loan_ids"> --}}
														...
														<tbody>
															...
															<tr>
																...
																<td>
																	...
																	<a href="{{route('destroydashboardroute',$dash->id)}}">
																	<button type="button" class="btn1 btn-outline-danger"><i class='bx bx-trash me-0'></i></button></a>
																	<a href="{{route('update_emi',$dash->id)}}"><button type="button" class="btn1 btn-outline-primary paid_btn" >Paid</button>
																		<a href="{{route('unpaidemis',$dash->id)}}"><button type="button" class="btn1 btn-outline-primary" >Unpaid</button></a>
																</td>
										...
										<div class="card">
											<div class="card-body">
												<div class="card-title d-flex align-items-center">
													...
													<h5 class="mb-0 text-primary">Paid EMI</h5>
												</div>
												<hr>
										...
										<div class="card">
											<div class="card-body">
												<div class="card-title d-flex align-items-center">
													...
													<h5 class="mb-0 text-primary">Unpaid EMI</h5>
												</div>
												<hr>
												<form class="row g-2">
