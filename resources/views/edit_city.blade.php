					...
					<div class="col-md-6 mx-auto" >
						<div class="card">
							<div class="card-body">
								...
								<hr>
								<form class="row g-2" method="post" action="{{route('update_city',$edit_data->id)}}">
									@csrf
							<div class="col-md-2"></div>
									<div class="col-md-4">
										<label for="inputFirstName" class="form-label">City</label>
										<input type="text" name='city' value='{{$edit_data->city}}'class="form-control" id="inputFirstName" placeholder="City" required>
									</div>
